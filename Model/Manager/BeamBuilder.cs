...
namespace VectordrawTest.Model.Manager
{
    public class BeamBuilder
    {
        ...
        public void Initialize(vdDocument document, BeamManager beamManager)
        {
            ...
            double horRot = 11.75712453;
            double verRot = 75.25248976;

            // 테스트 용
            // 수직
            gPoint point1 = new gPoint(61146.74121125, 21301.55129684, 0);
            gPoint point2 = new gPoint(62655.22197448, 24221.80129767, 0);
            ...
            // 수평
            gPoint point3 = new gPoint(60603.78979553, 21301.55129684, 0);
            gPoint point4 = new gPoint(61146.74121125, 21301.55129684, 0);
            ...
            beamManager.AddNewVerBeam(new Beam(center1, document, Color.Red, length1, width1, 62.680988160454746, "VerBeam_1"));
